      ...
      <CardContent className="p-3 flex items-center gap-3 min-h-0 h-full">
        ...
        <div className="flex-shrink-0 flex flex-col items-end gap-2">
          <button
            ...
            className="text-sm font-medium text-primary-foreground bg-primary border-none rounded-md shadow-sm flex items-center gap-2 transition-all duration-75 hover:bg-primary/90 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed w-full px-3 py-2"
          >
          ...
          <button
            ...
            className="text-sm font-medium text-foreground bg-background border border-border hover:bg-muted rounded-md shadow-sm flex items-center gap-2 transition-all duration-75 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed w-full px-3 py-2"
          >
